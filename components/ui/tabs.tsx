...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'bg-slate-800/50 inline-flex h-11 w-fit items-center justify-center rounded-full p-1 gap-1',
        className,
      )}
      {...props}
    />
