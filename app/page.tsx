...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-purple-900 to-orange-600 p-4" style={{ backgroundImage: 'url("/Login BG.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
